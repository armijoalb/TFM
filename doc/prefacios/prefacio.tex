...
Este estudio utilizará ocho conjuntos de datos sobre Series Temporales de Clasificación con diferentes grados de desbalanceo de clases. A estos se aplicarán SMOTE \cite{chawla2002smote}, ADASYN \cite{he2008adasyn} y MWMOTE \cite{barua2012mwmote} para realizar oversampling, existen otras técnicas que se han estudiado como el undersampling o el peso de clases pero no se han utilizan dentro del estudio. También se utiliza el algoritmo Boruta \cite{kursa2010boruta} como método de selección de características, existen otras características como selección de características con Chi-Cuadrado pero Boruta ofrece un buen rendimiento de forma general.\newline
...
Para la predicción se hará uso de las LSTM, uno de los tipos de red neuronal más utilizados en la actualidad; además de este, se utilizarán otros modelos que se encuentran en el estado del arte de la clasificación como son SVM \cite{boser1992training}, RandomForest \cite{breiman2001random} y XGBoost \cite{chen2016xgboost} y se comparán los resultados obtenidos.\newline
...
For the prediction, use will be made of LSTM, one of the most commonly used neural network types at present; in addition to this, other state of the art models for classification will be used, such as SVM \cite{boser1992training}, RandomForest \cite{breiman2001random} and XGBoost \cite{chen2016xgboost}, and the results obtained will be compared.\newline
